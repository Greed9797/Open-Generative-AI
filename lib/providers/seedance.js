...
const SEEDANCE_MODEL_MAP = {
  ...
  // i2v variants
  'seedance-lite-i2v':          'doubao-seedance-1-lite-i2v-250428',
  'seedance-pro-i2v':           'doubao-seedance-1-pro-i2v-250428',
  'seedance-pro-i2v-fast':      'doubao-seedance-1-pro-i2v-250428',
  'seedance-v1.5-pro-i2v':      'doubao-seedance-1.5-pro-i2v-250520',
};
...
export async function submit(payload, apiKey) {
  ...
  const content = payload.image_url
    ? [{ type: 'image_url', image_url: { url: payload.image_url } }, { type: 'text', text: payload.prompt || '' }]
